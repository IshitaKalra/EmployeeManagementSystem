...
<div align="center" class="container">
	<form id="contact" action="/editEmployee" method="post" class="form-group" style="width:300px;margin-top:100px;">
		<div>
			<input type="hidden" name="userId" class="valid" id="contact_userId" value="${userId}">
		</div>
		<div >
			<input type="hidden" name="employeeId" class="valid" id="contact_employeeId" value="${employeeId}">
		</div>
		<div class="form-group">
			<label for="contact_name">Name</label> 
			<input type="text" id="contact_name" name="name" class="form-control" value="${name}"> 
			<span class="error">This field is required</span>
		</div>
		<div class="form-group">
			<label for="contact_phone">Mobile Number</label> 
			<input type="text" id="contact_phone" name="phone" class="form-control" value="${employee.getPhone()}">
			 <span class="error">This field is required</span>
		</div>
		<div class="form-group">
			<label for="contact_salary">Salary</label> 
			<input type="text" id="contact_salary" name="salary" class="form-control" value="${employee.getSalary()}">
			 <span class="error">This field is required</span>
		</div>
		<div class="form-group">
			<label for="contact_password">Password</label> 
			<input type="text" id="contact_password" name="password" class="form-control" value="${employee.getPassword()}"> 
			<span class="error">This field is required</span>
		</div>
		<div class="form-group">
			<label for="contact_headId">headId</label> 
			<input type="text" id="contact_headId" name="headId" class="form-control" value="${employee.getHeadId()}"> 
			<span class="error">This field is required</span>
		</div>
